...
! for z3 compatibility; they map to ae/oe/ue/ss in z5+.
!
System_file;
...
! --- Close / Lock / Unlock via schliess ---
Verb 'schliess'
...
Verb 'geh' 'lauf' 'renn' 'wander' 'fluecht' 'flieh'
	* noun=ADirection                           -> Go
...
Verb 'entriegel' 'aufschliess' 'entsperr'
	* noun 'mit' held                           -> Unlock
	* noun                                      -> Unlock;
...
! --- Attack ---
Verb 'hau' 'tritt' 'toet' 'zerstoer' 'erschlag'
	* noun                                      -> Attack
...
Verb 'mist' 'scheiss' 'verflucht' 'verdammt' 'verflixt' 'fuck'
	*                                           -> Mild;
