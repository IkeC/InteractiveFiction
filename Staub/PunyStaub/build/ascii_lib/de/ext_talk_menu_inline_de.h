...
[ TM_MSG_TALK_ABOUT_WHAT;
	print "Was moechtest du zu ", (DE_dem) current_talker, " sagen?^";
];
#Endif;
...
Constant TM_MSG_TOPICS_DEPLETED "^Damit endet das Gespraech.";
#Endif;

! Shown when the player selects 0 / presses Enter without input.
#Ifndef TM_MSG_EXIT;
Constant TM_MSG_EXIT "Damit beendest du das Gespraech.";
#Endif;

! Shown when an NPC has no active topics at all.
#Ifndef TM_MSG_NO_TOPICS;
Constant TM_MSG_NO_TOPICS "Im Moment faellt dir kein passendes Thema ein.";
#Endif;
