...
"Provides a choice-based interface that can be freely switched between interactive and non-interactive modes. Basically, it does CYOA. (modded for Dust)"
...
To say page-told: 
	if Toldcounter of the current page is 2:
		say " I already told you that before![run paragraph on]";
	else if Toldcounter of the current page is greater than 15:
		say " I told you that [bold type]WAY TOO MANY[roman type] times already![run paragraph on]";
	else if Toldcounter of the current page is greater than 12:
		say " I told you that many, [italic type]MANY[roman type] times already![run paragraph on]";
	else if Toldcounter of the current page is greater than 2:
		say " I told you that [Toldcounter in words] times already![run paragraph on]";
...
Check choosing (this is the can't choose a number for a non-existent choice rule):
	if the number understood is 0:
		...
		say "Please select one of the available options or 0 to move on." (A) instead.
...
The CYOA error message is a text that varies. The CYOA error message is "Please select one of the available options or 0 to move on."
